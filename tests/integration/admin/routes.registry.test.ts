...
const ADMIN_COVERAGE: Array<{
  ...
  { method: 'get', path: '/admin/api/catalog', coveredBy: 'admin.catalog' },
  { method: 'get', path: '/admin/api/runtimes', coveredBy: 'admin.runtimes' },
  { method: 'post', path: '/admin/api/runtimes/install', coveredBy: 'admin.catalog' },
  { method: 'post', path: '/admin/api/runtimes/uninstall', coveredBy: 'admin.catalog' },
