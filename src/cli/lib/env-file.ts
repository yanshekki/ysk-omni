...
export function ensureEnvFile(
  ...
  const vars: Record<string, string> = {
    ...
    OMNI_DEFAULT_MODEL: '',
    OMNI_DEFAULT_CWD: `${paths.home.replace(/\\/g, '/')}/workspaces/default`,
    OMNI_CWD_ALLOWLIST: `${paths.home.replace(/\\/g, '/')}/workspaces`,
    OMNI_TIMEOUT_MS: '600000',
    OMNI_MAX_CONCURRENT: '4',
    OMNI_ALWAYS_APPROVE: 'true',
    OMNI_SAFE_MODE: 'false',
    OMNI_SAFE_MAX_TURNS: '4',
    OMNI_SAFE_TIMEOUT_MS: '120000',
